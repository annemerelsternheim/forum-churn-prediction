...
with open(os.path.join(path_out,'COPY_FIRST_if_code_is_running6.txt'),"w") as interim:
	...
	for i,b in enumerate(bounds):
		if bounds[i]!=bounds[-1]:
			...
			with open(os.path.join(path_out,'variable_combinations_results_balanced6.p'), 'w') as file:
				file.write(pickle.dumps(variable_combinations_results_balanced))
			with open(os.path.join(path_out,'variable_combinations_results_balanced6.txt'), 'w') as file:
				file.write(str(variable_combinations_results_balanced))
			
			with open(os.path.join(path_out,'variable_combinations_results_unbalanced6.p'), 'w') as file:
				file.write(pickle.dumps(variable_combinations_results_unbalanced))
			with open(os.path.join(path_out,'variable_combinations_results_unbalanced6.txt'), 'w') as file:
