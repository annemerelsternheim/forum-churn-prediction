...
def compare_variables(pp,user,nr_of_posts,mean_quest,mean_object,mean_sents,mean_length,mean_sent_length):
		...
		first_legend = plt.legend(handles=[posts,senlength,postlength], loc=2, bbox_to_anchor=(1.15, 0.3),title="Left axis")
		...
		second_legend = plt.legend(handles=[qmarks,ovalues,svalues], loc=3, bbox_to_anchor=(1.15, 0.7), title = "Right axis")
